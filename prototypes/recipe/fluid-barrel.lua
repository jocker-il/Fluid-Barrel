...
-- Update base crude recipes to be in the same categories
local fillcrude = data.raw.recipe["fill-crude-oil-barrel"]
fillcrude.subgroup = "fill-barrels"

local emptycrude = data.raw.recipe["empty-crude-oil-barrel"]
emptycrude.subgroup = "empty-barrels"
